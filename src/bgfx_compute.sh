...
#define BUFFER_RO(_name, _struct, _reg) LAYOUT(3, _reg) StructuredBuffer<_struct>    _name : REGISTER(t, _reg)
#define BUFFER_RW(_name, _struct, _reg) LAYOUT(3, _reg) RWStructuredBuffer <_struct> _name : REGISTER(u, _reg)
